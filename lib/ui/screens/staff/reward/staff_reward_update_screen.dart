...
class StaffRewardUpdateScreen extends ConsumerStatefulWidget {
  const StaffRewardUpdateScreen({super.key, required this.rewardId});
...
class _StaffRewardUpdateState extends ConsumerState<StaffRewardUpdateScreen> {
  ...
  Widget build(BuildContext context) {
    final rewardState = ref.read(staffRewardByIdProvider(widget.rewardId));
    final notifer = ref.read(staffRewardProvider.notifier);

    return Scaffold(
      appBar: AppBar(
        title: Text('Update Reward'),
      ),
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        ...
                        final message = await notifer.updateReward(
                          id: reward.id,
