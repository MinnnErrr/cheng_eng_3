...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartState&&const DeepCollectionEquality().equals(other.entries, entries));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( List<CartEntry> entries)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( List<CartEntry> entries)  $default,) {final _that = this;
switch (_that) {
case _CartState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( List<CartEntry> entries)?  $default,) {final _that = this;
switch (_that) {
case _CartState() when $default != null:
return $default(_that.entries);case _:
  return null;
...
class _CartState extends CartState {
  const _CartState({final  List<CartEntry> entries = const []}): _entries = entries,super._();
  

 final  List<CartEntry> _entries;
@override@JsonKey() List<CartEntry> get entries {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _CartState&&const DeepCollectionEquality().equals(other._entries, _entries));
}
